...
import com.dyx.interview.config.WxOpenConfig;
...
import com.dyx.interview.model.dto.user.*;
...
public class UserController {
    ...
    public BaseResponse<Long> addUser(@RequestBody UserAddRequest userAddRequest, HttpServletRequest request) {
        ...
        String encryptPassword = DigestUtils.md5DigestAsHex(("dyx" + defaultPassword).getBytes());
